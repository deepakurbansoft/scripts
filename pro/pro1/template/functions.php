...
include_once( THEME_DOCUMENT_ROOT . '/inc/ut-theme-filters.php' );
...
add_shortcode( 'counter_section', 'counter_section' );
...
$slider_gallery = '';
	...
	$slider_gallery.='<div id="wa_chpc_slider" style="height:auto; overflow: hidden;">';
			...
			while( $query->have_posts() ){
			   ...
			   $query->the_post();
				...
				$post_link =  get_permalink();
						...
						$slider_gallery.= '<div class="chpcs_foo_content content_count_'.$cunt.'" style="width:'.$item_width.'px; height:auto;">';
					$count_icon = get_field('counter_icon',false, false);
					$count_num = get_field('counter_number', false, false);
					
					$count_end = get_field('counter_end_string', false, false);
					
				$slider_gallery.= '<div class="'.$count_num.' ut-counter-box ut-counter ut-already-counted" data-effecttype="counter" data-animateonce="no"><i class="fa '.$count_icon.' fa-4x"></i><span #ffffff="" class="ut-count"><span class="count_num">'.$count_num.'</span>'.$count_end.'</span><h3 class="ut-counter-details"> '.$post_title.'</h3></div>';
