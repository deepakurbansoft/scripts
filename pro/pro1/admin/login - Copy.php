...
<div class="login-box">
    <div class="login-logo">
        <a href="login"><b>cashbookpickandclick</b>.com</a>
    </div><!-- /.login-logo -->
...
<!--                        </label>-->
                ...
                <div class="col-xs-4">
					...
					<input type="button" id="adminlogin" href="#" class="btn btn-primary btn-block btn-flat" value="Login">
...
//login code 
		 ...
		 window.location.replace("dashboard.php");
            ...
            // $('#loginbox').shake();
			 ...
			 $("#login").val('Login')
			 $("#error").html("<span style='color:#cc0000'>Error:</span> Invalid Email Id and Password. ");
            }
            }
            });
			//ajax end
