...
if (isset($_POST['invoice']) && isset($_POST['date'])) {
    ...
    mysql_query($con, "UPDATE subsciption SET paid_date='$pay_date', total='$total', paid='$paid', sub_type_name='$mem_type', bal='$bal', sub_type='$sub_type', expiry='$expiry', exp_time='$exp_time' WHERE invoice='$invoice'");
