...
//										$query  = "SELECT * FROM subsciption INNER JOIN user_data ON bal>0 AND user_data.wait='no' ORDER BY bal DESC" ;
//									}else{
//										$location = $_SESSION['gym_location'];
//										$query  = "SELECT * FROM subsciption INNER JOIN user_data ON bal>0 AND user_data.gym_location = '$location' AND user_data.wait='no' ORDER BY bal DESC" ;
//									}
