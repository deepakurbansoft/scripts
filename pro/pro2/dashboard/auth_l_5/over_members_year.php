...
<div class="container-fluid" id="content">
				...
				<div class="breadcrumbs">
					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-th-list"></i>Year</h3>
							</div>
 ...
 <div class="control-group">
										...
										<div class="controls"><span id="sprytextfield3">
										  <input type="text" name="from" id="textfield22" class="input-medium" value="<?php echo date('Y'); ?>" placeholder="<?php echo date('Y'); ?>">
