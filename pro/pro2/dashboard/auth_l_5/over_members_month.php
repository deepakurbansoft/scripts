...
<!--								       <input type="text" name="from" id="myDatepicker" class="input-medium datepicker" value="">-->
								       <input type="text" name="from" id="myDatepicker" class="input-medium datepicker" value="<?php echo date('Y-m'); ?>" placeholder="<?php echo date('Y-m'); ?>">
...
<!--										<div class="controls"><span id="sprytextfield3">-->
<!--										  <input type="text" name="to" id="textfield22" class="input-medium datepicker" value="--><?php //echo date('Y-m'); ?><!--">-->
<!--									    <span class="textfieldRequiredMsg">A value is required.</span></span></div>-->
<!--									</div>-->
