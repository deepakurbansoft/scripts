...
<div class="container-fluid" id="content">
				...
				<div class="breadcrumbs">
					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-th-list"></i>Month</h3>
							</div>
							<div class="box-content nopadding">
								<form action="income_month.php" method="POST" class='form-horizontal form-bordered'>
 ...
 <div class="control-group">
										...
										<div class="controls"><span id="sprytextfield3">
										  <input type="text" name="from" id="textfield22" class="input-medium" value="<?php echo date('Y-m'); ?>" placeholder="<?php echo date('Y-m'); ?>">
