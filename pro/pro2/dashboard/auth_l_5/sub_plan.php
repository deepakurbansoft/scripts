		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li>
						<a href="view_plan_sub.php">Plans</a>
						<i class="icon-angle-right"></i>
					</li>
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box box-bordered box-color">
						<div class="box-title">
							<h3><i class="icon-th-list"></i> Add New Plan - Sub </h3>
						</div>
						<div class="box-content nopadding">

							<form action="submit_plan_sub.php" method="POST" class='form-horizontal form-bordered'>
