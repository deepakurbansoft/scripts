...
<!--Members Payments : --><?php //echo $from; ?>
							...
							<div class="box-content nopadding">
								<table class="table table-nomargin dataTable dataTable-tools  table-bordered">
                                 ...
                                 $query  = "SELECT * FROM subsciption INNER JOIN user_data ON subsciption.mem_id=user_data.newid AND user_data.wait='no'";
...
?>
							...
							</div><h4>Total Payments  : <?php
    echo $sno - 1;
?></h4><h4>Total Income : <?php
    echo $total;
?></h4>
						</div>
					</div>
