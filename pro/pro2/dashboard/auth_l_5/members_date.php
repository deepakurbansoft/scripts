	  ...
	  <?php include 'common_files/header_dashboard.php'; ?>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="#"> Total Members - Location	</a>
...
<!--								</div>-->
								...
								<div style="" class="pull-right">
                                    ...
                                    <input type="text" name="from" id="myDatepicker" class="input-medium datepick"  placeholder="<?php echo date('Y-m'); ?>">

									<span style="padding-bottom: 2px;">To Date : </span>&nbsp;

                                    <input type="text" name="to" id="textfield22" class="input-medium datepick" placeholder="<?php echo date('Y-m'); ?>">
							...
							<div class="box-content nopadding">
								<table class="table table-nomargin dataTable dataTable-tools  table-bordered">
									<thead>
										<tr>
											<th>S.No</th>
											<th>Membership ID</th>									<th>Name</th>										<th>Age / Sex</th>										<th>Join On</th>
										</tr>
									</thead>
									<tbody>
									<?php
