...
The Basic Idea:
You add users to have full access to the calendar, each user that creates a event is visible to all users. The created user is administrator. If you want each user
to have each event you can implement that or check (Demo3). 
