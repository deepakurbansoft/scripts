  ...
  <body>
    ...
    <script type="text/javascript">
		$().FullCalendarExt({
			...
			quickSaveCategory: '<label>Category: </label><select name="categorie" class="form-control"><?php foreach($calendar->getCategories() as $categorie) { ?> <option value="<?php echo $categorie?>"><?php echo $categorie; ?></option><?php } ?></select>',
			//weekType: 'agendaWeek',
			//dayType: 'agendaDay',
