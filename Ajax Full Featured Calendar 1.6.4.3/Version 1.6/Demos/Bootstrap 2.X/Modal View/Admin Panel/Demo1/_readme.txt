...
This demo does not support multi-users private events, but you can implement it.

The Basic Idea:
You add users to have full access to the calendar, each user that creates a event is visible to all users. If you want each user
to have each event you can implement that and will be easier to do that than fallback to this basic idea. 
Its just a protected version of (Demo2) your events with ability to add users and filter category. You are able to add and remove
