      ...
      <div class="box">
        ...
        <div class="content pad"> 
            ...
            <form id="edit_event" method="post">
                ...
                <label>Title:</label>
                <input type="text" class="validate[required] input-block-level" name="title_update" id="title_update" placeholder="Event Title" value="<?php echo $info['title']; ?>">
                <label>Description:</label>
                <textarea class="input-block-level" name="description_update" id="description_update" placeholder="Event Description"><?php echo $info['description']; ?></textarea>
