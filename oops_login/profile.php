            ...
            <div class="row coralbg white">
                <div class="col-md-6 no-pad">
                    <div class="user-pad">
                        ...
                        <h4 class="white pull-right"><a href="index.php" style="color: #ffffff;"> <i class="glyphicon glyphicon-log-out"></i> Log out</a></h4>
                    </div>
                </div>
                <div class="col-md-6 no-pad">
        ...
        <div class="col-md-4 user-menu user-pad">
            <div class="user-menu-content active">
                ...
                <ul class="user-menu-list">
                    ...
                    <li>
                        <button type="button" class="btn btn-labeled btn-success" href="index.php">
                    ...
                    <li>
                        <button type="button" class="btn btn-labeled btn-success" href="#">
                            <span class="btn-label"><i class="glyphicon glyphicon-log-out"></i></span>Sign out</button>
                    </li>
                </ul>
            </div>
