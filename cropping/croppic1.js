...
(function (window, document) {
	...
	croppic1.prototype = {
		...
		createModal: function(){
			...
			var modalHTML =  '<div id="croppic1Modal">'+'<div id="croppic1ModalObj" style="width:'+ that.objW +'px; height:'+ that.objH +'px; margin:0 auto; margin-top:'+ marginTop +'px; position: relative;"> </div>'+'</div>';

			$('body').append(modalHTML);
			
			that.modal = $('#croppic1Modal');
			
			that.obj = $('#croppic1ModalObj');
			...
			$.ajax({
                ...
                type: 'POST'
					...
					if(response.status=='success'){
						...
						that.obj.append('<img class="croppedImg" src="'+response.url+'"><input type="file" name="photo" value="'+response.url+'">');
