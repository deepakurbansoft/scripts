...
<input type="submit" class="btn btn-default pull-left" value="Skip" name="addhomeskip">
            ...
            <div class="col-md-10">
			  <form action="/property-cart/" method="POST">
...
<div class="row">
 ...
 if($data->payment_status!=0){
									...
									?>
												...
												<input type="checkbox" name="pay[]" value="<?php echo $data->prop_id; ?>"> Check for pay this property
...
if($paymentpage==1){				
                ?>
				 <input type="submit"  class="pull-right" name="submit_pay" value="Pay">
<?php } ?>
</form>
            </div>
    ...
    <div class="col-sm-3">
        ...
        <ul class="nav nav-pills nav-stacked nav-email shadow mb-20">
           ...
           <a href="/dashboard"><i class="fa fa-sign-out"></i> Raise Ticket</a>
            ...
            <li><a href="#" data-toggle="tab"> <i class="fa fa-tags"></i> Offers</a></li>
            <li><a href="#" data-toggle="tab"> <i class="fa fa-external-link"></i> Logout</a></li>
        </ul><!-- /.nav -->
    </div>
    <div class="col-sm-9">
